...
public class UIAdapterForMenu : MonoBehaviour
{
    ...
    void Update()
    {
        if (Screen.orientation == ScreenOrientation.Portrait || Screen.orientation == ScreenOrientation.PortraitUpsideDown)
        {
            ...
            playButton.transform.localPosition = new Vector3(0, -50, 0);
            quitButton.transform.localScale = new Vector3(1.5f, 0.5f, 1f);
            quitButton.transform.localPosition = new Vector3(0, -120, 0);
        ...
        if (Screen.orientation == ScreenOrientation.LandscapeLeft || Screen.orientation == ScreenOrientation.LandscapeRight)
        {
            ...
            playButton.transform.localPosition = new Vector3(260, 0, 0);
